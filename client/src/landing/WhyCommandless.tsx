...
const problems: Item[] = [
  { title: "The Command Problem", body: "Users memorize /commands and syntax. Every friction breaks flow, increases drop-off, and creates support load." },
  { title: "Lost in Menus", body: "Nested menus and modal dialogs slow users. What should be a quick action turns into a scavenger hunt." },
  { title: "One‑off Integrations", body: "Each new feature needs custom wiring to your bot. Duplicated effort, inconsistent UX, and brittle logic." },
];

const solutions: Item[] = [
  { title: "Natural Language Mappings", body: "Map everyday language to your existing commands. No retraining users, no command sheets." },
  { title: "Guided Conversations", body: "Micro‑prompts gather the right context automatically. Users finish tasks faster with fewer mistakes." },
  { title: "Drop‑in Layer", body: "Keep your bot logic. We orchestrate intent, parameters, and execution—so you ship features, not plumbing." },
];
...
export default function WhyCommandless() {
